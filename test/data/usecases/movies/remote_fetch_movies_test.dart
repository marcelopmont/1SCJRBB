...
class HttpClientMock extends Mock implements HttpClient {
  ...
  void mockGetError(HttpError error) =>
      when(() => get(url: 'https://demo7206081.mockable.io/movies',)).thenThrow(
          error);
}
...
void main() {
  ...
  test('Should return InvalidCredential if client return unauthorized', () async {
